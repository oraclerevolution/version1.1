        ...
        return (
            <View style={{flex:1}}>
                <Header
                    ...
                    centerComponent={{ text: 'Africa Web APP', style: { color: '#fff', fontSize:18, fontFamily:'BlissPro-Bold' } }}
                />
                <ScrollView style={styles.container}>
                    ...
                    <Text style={{textAlign:'left', marginTop:25, marginBottom:5, fontSize:20,fontWeight:'bold',fontFamily:'BlissPro-Bold'}}>Explorez</Text>
                    <View>
                        ...
                        <TouchableOpacity style={styles.item}>
                            <Text style={{fontWeight: 'bold', fontSize:18,fontFamily:'BlissPro-Bold'}}><Icon name="ios-person" size={23} color="#0a2849"/> Intervenants</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.item}>
                            <Text style={{fontWeight: 'bold', fontSize:18,fontFamily:'BlissPro-Bold'}}><Icon name="ios-bulb" size={23} color="#0a2849"/> Innovations</Text>
                        </TouchableOpacity>

                    </View>

                    <Text style={{textAlign:'left', marginTop:25, marginBottom:5, fontSize:20,fontWeight:'bold',fontFamily:'BlissPro-Bold'}}>Nos partenaires</Text>
                    <View style={{alignItems:'center', justifyContent:'center', backgroundColor:'white', padding:10}}>
                        <Image
                    ...
                    <Text style={{textAlign:'left', marginTop:25, marginBottom:5, fontSize:20,fontWeight:'bold',fontFamily:'BlissPro-Bold'}}>Informations pratiques</Text>
                    <View style={{marginBottom:20}}>
                        <TouchableOpacity style={styles.item2}>
                            ...
                            <View style={{flex:3,justifyContent:'center', alignItems: 'center'}}>
                                <Text style={{fontSize:19, fontWeight: 'bold',fontFamily:'BlissPro-Bold'}}>De 08h à 17h</Text>
                            </View>
                        </TouchableOpacity>
                ...
                <View style={{backgroundColor:'#0a2849', height:80,}}>
                    <Text style={{textAlign:'center', color:'white',fontSize:13, padding:10,fontFamily:'BlissPro-Bold'}}>© AFRICA WEB APP - TOUS DROITS RESERVES</Text>
                    <Text style={{textAlign:'center', color:'white',fontSize:13,fontFamily:'BlissPro-Bold'}}>App powered by WeenovIT ®</Text>
                </View>
            </View>
        );
    }
